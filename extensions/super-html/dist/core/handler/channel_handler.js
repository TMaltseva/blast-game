...
class channel_handler {
    async run() {
        ...
        for (let key in inject_channel_adapter) {
            ...
            {
                if (s_html_name) {
                    s_html_name = `${s_channel_name}%${s_html_name}.html`;
                }
                else {
                    s_html_name = `${s_channel_name}.html`;
                }
                if (d_hot.s_title) {
                    s_html_name = `${d_hot.s_title}%${s_html_name}`;
                }
            }
            // zip文件名
            ...
            {
                if (s_zip_name) {
                    s_zip_name = `${s_channel_name}%${s_zip_name}.zip`;
                }
                else {
                    s_zip_name = `${s_channel_name}.zip`;
                }
                if (d_hot.s_title) {
                    s_zip_name = `${d_hot.s_title}%${s_zip_name}`;
                }
            }
            // #### 渠道脚本
